...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Shedule = __webpack_require__(160);

	var _Shedule2 = _interopRequireDefault(_Shedule);

	var data = _Shedule2['default'];
	console.log(data);

	exports['default'] = function (props) {
	  console.log(_Shedule2['default']);
	  return _react2['default'].createElement(
	    'div',
	    null,
	    'Ваше имя: ',
	    _react2['default'].createElement('input', { type: 'text', id: 'login', defaultValue: 'Гость' })
	  );
	};
...
/***/ function(module, exports) {
	...
	exports["default"] = function () {
	    return [{
	        ...
	        last: "Manaenko",
	        age: 41,
	        description: "My stydy begin with that excersize",
	        thumbnail: 'img/face.png'
	    }, {
	        id: 2,
	        first: "Sergey",
	        last: "Bobrynin",
